...
class WanProjectAdapter(data: MutableList<WanProjectBean.Data.DataX>?) :
    BaseQuickAdapter<WanProjectBean.Data.DataX, BaseViewHolder>(
        R.layout.item_wan_article,
        data
    ) {
    override fun convert(helper: BaseViewHolder, item: WanProjectBean.Data.DataX) {
